export const loadDOM = function (listOfJobs) {
  ...
  export const projectCard = function(project) {
    ...
    <div>
      ...
      <li class="mr-2">
      <a aria-label="GitHub" class="social-link-3 img" data-platform="github" href=${project.gitLink} target="_blank" rel="noreferrer">
      ...
      <li class="mr-2">
      <a aria-label="LinkedIn" class="social-link-3 img" data-platform="linkedin" href=${project.viewLink} target="_blank" rel="noreferrer">
    ...
    <div>
    <a class="img" href=${project.viewLink}>
  ...
  */
  ...
  {
    id: 3,
    name: "ML/AI for Carvana",
    description: "Created a Machine Learning classification model to predict whether a used car bought at auction is good/bad by using Ensemble methods, Random Forest and Boosting.",
    img: "carvana.png"
    , tag: "R, XGBoost, GLM, ML",
    tagExtra: "",
    gitLink: "https://github.com/juneadkhan/Carvana-Dont-Get-Kicked",
    viewLink: "https://github.com/juneadkhan/Carvana-Dont-Get-Kicked/blob/main/KhanJunead-BIOS635FinalProject.pdf"
